...
function BuscarAModificar(){
	...
	var  modificar=document.getElementById('buscar').value;
	var informacionDelUsuario = "BuscarUsuarioAmodificar="+buscar+"&Usuario1="+usuario;
...
function Modificar(){		
        ...
        var w = document.getElementById("modificar").value;       
